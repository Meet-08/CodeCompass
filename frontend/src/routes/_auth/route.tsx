    ...
    <div className="min-h-screen w-full bg-[#080B11] text-slate-100 flex flex-col lg:flex-row relative overflow-hidden font-sans selection:bg-orange-500/30 selection:text-orange-200">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-slate-400 font-medium tracking-wide">AI Code Intelligence</span>
            </div>
          </div>
        </div>
        ...
        <div className="my-auto py-8 max-w-xl">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="p-4 rounded-2xl bg-slate-900/50 border border-slate-800/80 hover:border-orange-500/40 hover:bg-slate-900/80 transition-all duration-300 group">
              ...
              <h3 className="text-sm font-semibold text-white mb-1">Semantic Search</h3>
              <p className="text-xs text-slate-400 leading-relaxed">Search by intent and logic across millions of lines of code.</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-900/50 border border-slate-800/80 hover:border-cyan-500/40 hover:bg-slate-900/80 transition-all duration-300 group">
              ...
              <h3 className="text-sm font-semibold text-white mb-1">AI Documentation</h3>
              <p className="text-xs text-slate-400 leading-relaxed">Auto-generate comprehensive docs and system flow explanations.</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-900/50 border border-slate-800/80 hover:border-purple-500/40 hover:bg-slate-900/80 transition-all duration-300 group">
              ...
              <h3 className="text-sm font-semibold text-white mb-1">Dependency Graphs</h3>
              <p className="text-xs text-slate-400 leading-relaxed">Visualize clear module relationships and data dependencies.</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-900/50 border border-slate-800/80 hover:border-emerald-500/40 hover:bg-slate-900/80 transition-all duration-300 group">
              ...
              <h3 className="text-sm font-semibold text-white mb-1">Architecture Maps</h3>
              <p className="text-xs text-slate-400 leading-relaxed">Deep-dive into component structures and execution paths.</p>
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-slate-900/90 border border-slate-800 shadow-2xl p-4 font-mono text-xs overflow-hidden backdrop-blur-md relative">
            <div className="flex items-center justify-between border-b border-slate-800/80 pb-3 mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="ml-2 text-slate-400 text-[11px] font-sans">UserService.ts</span>
              </div>
            ...
            <div className="space-y-1 text-slate-300">
              <div className="text-slate-500">// AI Query: Map authentication flow and token refresh</div>
              <div><span className="text-purple-400">export async function</span> <span className="text-blue-400">authenticateUser</span>(credentials: UserAuth) &#123;</div>
              <div className="pl-4 text-slate-400">// Querying CodeCompass Vector Graph...</div>
              <div className="pl-4 bg-orange-500/10 text-orange-200 border-l-2 border-orange-500 py-0.5 px-2 rounded-r">
                <span className="text-purple-400">const</span> token = <span className="text-purple-400">await</span> AuthEngine.verifyAndSign(credentials);
              </div>
              <div className="pl-4"><span className="text-purple-400">return</span> &#123; status: <span className="text-emerald-400">'AUTHENTICATED'</span>, token &#125;;</div>
              <div>&#125;</div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-10 lg:p-12 xl:p-16 relative z-10 my-auto">
        ...
        <div className="absolute top-6 left-6 lg:hidden flex items-center gap-2.5">
          <img src="/logo.png" alt="CodeCompass Logo" className="w-8 h-8 object-contain" />
